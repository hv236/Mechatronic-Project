...
#  ***THE BELOW CODE ALMOST WORKS BUT NEEDS FIXING SO THAT THE robot_ind index variable is just a single integer***
...
# print("Angles Matrix = ", angles_matrix)
beta = np.degrees(angles_matrix[2])
beta = 0 - beta
# print("Angle between robot ID and nearest ID =", beta, "degrees")
...
# Combine beta and sigma above to calculate the movement direction needed by the robot (alpha in notes)
sigma = alpha - beta

# Convert to counter clockwise motion if faster
if sigma > 180:
    sigma = sigma - 360
print("Angle the robot needs to turn to reach ID =", sigma)